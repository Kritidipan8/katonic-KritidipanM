...
Deploy Model → GitHub → text-classification/model.pkl → Text Classification → Deploy
Deploy LLM → HuggingFace → sshleifer/tiny-gpt2 → CPU → Deploy
Fine-Tune → sshleifer/tiny-gpt2 → Upload training_data.jsonl → Start
